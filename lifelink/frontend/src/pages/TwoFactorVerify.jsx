    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-primary-50 flex items-center justify-center px-4 py-10 -mx-4 sm:-mx-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 text-center">
          {/* Icono */}
          <div className="w-16 h-16 bg-gradient-to-br from-primary-100 to-medical-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-8">
            Abre tu app autenticadora (Google Authenticator, Authy)
          ...
          <form onSubmit={handleSubmit}>
              ...
              {digits.map((d, i) => (
                <input
                  ...
                  className={`w-11 h-14 text-center text-xl font-black rounded-xl border-2 transition-all focus:outline-none
                    ${d ? 'border-primary-500 bg-primary-50 text-primary-900'
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 shadow-lg"
            >
              {loading
