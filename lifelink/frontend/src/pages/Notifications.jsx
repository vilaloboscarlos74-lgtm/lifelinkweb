...
const TYPE_COLORS = {
  solicitud_nueva:    'bg-primary-100 text-primary-600',
  solicitud_aceptada: 'bg-success-100 text-success-700',
  solicitud_rechazada:'bg-accent-100 text-accent-600',
  mensaje_nuevo:      'bg-blue-100 text-blue-600',
  resena_nueva:       'bg-amber-100 text-amber-600',
    ...
    <div className="max-w-2xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 animate-fade-in">
          ...
          <h3 className="font-bold text-gray-700 text-lg mb-1">Sin notificaciones</h3>
          <p className="text-gray-400 text-sm">Aquí aparecerán las actualizaciones de tu cuenta</p>
        </div>
      ) : (
        <>
            ...
            {notifs.map((n) => {
              ...
              return (
                <div
                  ...
                  className={`group bg-white rounded-2xl p-4 flex items-start gap-3 border transition-all duration-200 animate-fade-in ${
                    n.link ? 'cursor-pointer' : 'cursor-default'
                  } ${
                    !n.is_read
                      ? 'border-primary-100 bg-primary-50/30 shadow-sm hover:shadow-md'
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={`text-sm leading-snug ${!n.is_read ? 'font-bold text-gray-900' : 'font-medium text-gray-700'}`}>
                      {n.title}
                    </p>
                    <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">{n.content}</p>
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-red-50 hover:text-red-500 text-gray-400 transition-all"
                    >
                      <Trash2 size={13} />
                    </button>
                  </div>
